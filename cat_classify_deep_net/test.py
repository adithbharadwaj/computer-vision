...
def init_params(layers):
	...
	w4 = np.random.randn(layers[4], layers[3]) * np.sqrt(2/layers[3])
	b4 = np.random.randn(layers[4], 1)
...
if __name__ == '__main__':
	...
	layers = [x_train.shape[0], 40, 25, 15, 1]
	...
	print("3 hidden layer network ", layers)		
